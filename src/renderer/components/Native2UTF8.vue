...
<div id="mainContent" class="wrapper">
	...
	<div class="toolsTab  clearfix">
	    <ul class="nav nav-tabs">
            ...
            <li class="active"><a  v-on:click="gotoNative2UTF8">Native/UTF-8</a></li>
  ...
  export default {
    ...
    methods: {
      Native2UTF8 () {
        ...
        $("#u_source").val(n_s.replace(/[^\u0000-\u00FF]/g, function ($0) { return escape($0).replace(/(%u)(\w{4})/gi, "&#x$2;") }));
      },
      UTF82Native () {
        var code = $("#u_source").val();
	    $("#n_source").val(unescape(code.replace(/&#x/g, '%u').replace(/;/g, '')));
      },
      gotourlencode() {
		  this.$router.push({
			  name : 'urlencode'
